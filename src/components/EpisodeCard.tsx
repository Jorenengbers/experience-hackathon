    ...
    <ViewTransition name={`episode-card-${episode.id}`} share="card-morph">
      ...
      >
        ...
        {episode.status === 'unplayed' && (
          <div className="absolute top-4 right-4 w-2 h-2 rounded-full" style={{ background: accent }} />
        )}

        <div className="p-4">
          {/* Edition label */}
          <div className="text-[10px] font-semibold tracking-widest uppercase mb-1" style={{ color: accent }}>
            {episode.edition} edition
          </div>

          {/* Title */}
          <div className="text-[18px] mb-2 leading-tight" style={{ fontFamily: 'var(--font-playfair)', color: '#f0ede8' }}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px]" style={{ color: '#9b9890' }}>{episode.duration}</span>
            </div>
            ...
            {isUnavailable ? (
              ...
              <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: '#1e1e21' }}>
